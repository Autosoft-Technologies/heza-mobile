                        ...
                        <div className="col-lg-6 col-lg-6 col-md-8">
                            <div className="cta-satisfied">
                                <div className="single-satisfied mb-50">
                                    ...
                                    <p>
                                        Our three categories of rewards have been givent to thousands of people and most
                                        of them were appreciative to their providers
                                    </p>
                                </div>
                                <div className="single-satisfied mb-50">
                                    <h1>100+</h1>
                                    ...
                                    <p>
                                        We have enabled many companies appreciate back their customers through various
                                        digital gifts
                                    </p>
                                </div>
                            </div>
