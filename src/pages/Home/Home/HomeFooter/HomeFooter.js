                            ...
                            <div className="col-xl-5 col-lg-6 col-md-8">
                                <div className="footer-contact-info mb-30">
                                    ...
                                    <div className="footer-emailing">
                                        <ul>
                                            <li><i className="far fa-envelope"></i>info@mobile.com</li>
                                            <li><i className="far fa-clone"></i>mobile.com</li>
                                            <li><i className="far fa-flag"></i>Bugoloobi, Kampala Uganda</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="row">
                            <div className="col-xl-12">
                                <div className="footer-copyright text-center">
                                    <p className="white-color">Copyright by@ Moobile - 2022 &nbsp; | &nbsp; Powere by Autosoft</p>
                                </div>
                            </div>
                        </div>
                    </div>
